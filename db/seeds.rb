...
Comment.create({track_id:5, user_id:3, body: "http://giphy.com/gifs/crying-leonardo-dicaprio-love-5WmyaeDDlmb1m"})
...
Comment.create({track_id:9, user_id:4, body: "live footage of me rn: http://giphy.com/gifs/tvland-sad-crying-l0MYwPRszMw0YF0v6"})
