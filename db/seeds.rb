...
Comment.create({track_id:4, user_id:1, body: ""})
Comment.create({track_id:5, user_id:1, body: ""})
Comment.create({track_id:5, user_id:3, body: ""})
Comment.create({track_id:6, user_id:1, body: ""})
Comment.create({track_id:6, user_id:2, body: ""})
...
Comment.create({track_id:9, user_id:4, body: "live footage of me right now: http://giphy.com/gifs/tvland-sad-crying-l0MYwPRszMw0YF0v6"})
...
Comment.create({track_id:11, user_id:4, body: ""})
Comment.create({track_id:12, user_id:1, body: ""})
Comment.create({track_id:12, user_id:2, body: ""})
Comment.create({track_id:12, user_id:1, body: "love love love"})
Comment.create({track_id:13, user_id:1, body: ""})
Comment.create({track_id:13, user_id:4, body: ""})
Comment.create({track_id:13, user_id:3, body: ""})
Comment.create({track_id:13, user_id:1, body: ""})
Comment.create({track_id:14, user_id:4, body: ""})
Comment.create({track_id:15, user_id:5, body: ""})
Comment.create({track_id:15, user_id:1, body: ""})
Comment.create({track_id:16, user_id:5, body: ""})
Comment.create({track_id:16, user_id:4, body: ""})
Comment.create({track_id:17, user_id:1, body: ""})
Comment.create({track_id:17, user_id:5, body: "what even. so amazing."})
Comment.create({track_id:18, user_id:1, body: ""})
Comment.create({track_id:19, user_id:2, body: ""})
Comment.create({track_id:19, user_id:3, body: ""})
Comment.create({track_id:20, user_id:1, body: ""})
Comment.create({track_id:20, user_id:5, body: ""})
Comment.create({track_id:20, user_id:4, body: ""})
Comment.create({track_id:21, user_id:1, body: ""})
Comment.create({track_id:21, user_id:1, body: ""})
Comment.create({track_id:22, user_id:5, body: ""})
Comment.create({track_id:23, user_id:5, body: ""})
Comment.create({track_id:23, user_id:1, body: ""})
Comment.create({track_id:24, user_id:2, body: ""})
Comment.create({track_id:24, user_id:2, body: ""})
Comment.create({track_id:24, user_id:1, body: ""})
Comment.create({track_id:25, user_id:3, body: ""})
Comment.create({track_id:25, user_id:1, body: ""})
Comment.create({track_id:26, user_id:1, body: ""})
Comment.create({track_id:26, user_id:5, body: ""})
Comment.create({track_id:27, user_id:1, body: ""})
Comment.create({track_id:27, user_id:2, body: ""})
Comment.create({track_id:28, user_id:3, body: ""})
Comment.create({track_id:29, user_id:1, body: ""})
Comment.create({track_id:29, user_id:3, body: ""})
Comment.create({track_id:30, user_id:2, body: ""})
Comment.create({track_id:30, user_id:1, body: ""})
Comment.create({track_id:30, user_id:5, body: ""})
Comment.create({track_id:30, user_id:3, body: ""})
Comment.create({track_id:31, user_id:1, body: ""})
Comment.create({track_id:31, user_id:4, body: ""})
Comment.create({track_id:32, user_id:5, body: ""})
Comment.create({track_id:32, user_id:1, body: ""})
Comment.create({track_id:33, user_id:2, body: ""})
Comment.create({track_id:33, user_id:1, body: ""})
Comment.create({track_id:35, user_id:4, body: ""})
Comment.create({track_id:36, user_id:3, body: ""})
